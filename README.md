...
[![codecov](https://codecov.io/gh/JuliaAstro/Astrometry.jl/graph/badge.svg)](https://codecov.io/gh/JuliaAstro/Astrometry.jl)
[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

`Astrometry.jl` is a set of IAU standard algorithms for calculating the time and position of celestial objects. More information can be found on the official website of the [Standards of Fundamental Astronomy](https://www.iausofa.org/).
